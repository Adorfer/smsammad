...
#
# Aufruf: cron_run.sh <ticket-to-sms|sms-to-ticket|balance-check|stats|check-setup|reset-access> [weitere Argumente]

set -uo pipefail

TASK="${1:?Usage: $0 ticket-to-sms|sms-to-ticket|balance-check|stats|check-setup|reset-access}"
shift
